...
void app_main(void)
{
    ...
    const char *dataR = "255|0|0";
    const char *dataG = "0|255|0";
    const char *dataB = "0|0|255";
    ...
    while (true)
    {
        ...
        {
        case 0:
            esp_now_send_data(peer_mac, (const uint8_t *)dataR, strlen(dataR));
            led_strip_set_pixel(led_strip, 0, 255, 0, 0);
            break;

        case 1:
            esp_now_send_data(peer_mac, (const uint8_t *)dataG, strlen(dataG));
            led_strip_set_pixel(led_strip, 0, 0, 255, 0);
            break;

        case 2:
            esp_now_send_data(peer_mac, (const uint8_t *)dataB, strlen(dataB));
